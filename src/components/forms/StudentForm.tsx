...
import { createStudentDirect, updateStudentDirect } from "@/lib/actions";
...
const StudentForm = ({
  ...
  const onSubmit = handleSubmit(async (formData) => {
    const result = await (type === "create"
      ? createStudentDirect({ ...formData, img: img?.secure_url })
      : updateStudentDirect({ ...formData, img: img?.secure_url }));
